/*
=============================================================================
ANÁLISIS DE EMBUDO DE MERCADOLIBRE – EXPLORACIÓN INICIAL DE DATOS
=============================================================================
Objetivo: Explorar la estructura y calidad de los datos del embudo y retención
Herramientas: SQL, PostgreSQL
=============================================================================
*/

-- =====================================================
-- 1. EXPLORACIÓN GENERAL DE TABLAS
-- =====================================================
-- Objetivo: Validar estructura y contenido inicial de las tablas
...
-- =====================================================
-- Objetivo: Identificar las etapas que componen el embudo
...
-- =====================================================
-- Objetivo: Revisar volumen y unicidad de usuarios
...
/*
=============================================================================
ANÁLISIS DE EMBUDO DE CONVERSIÓN – MERCADOLIBRE
=============================================================================
Autor: Dayana Rodríguez
Fecha: 2025-08-31
Objetivo: Medir conversión entre etapas del embudo de compra
Herramientas: SQL, PostgreSQL
=============================================================================
*/

-- =====================================================
-- 1. DEFINICIÓN DE CTEs POR ETAPA DEL EMBUDO
-- =====================================================
...
-- =====================================================
-- 2. CONTEO DE USUARIOS POR ETAPA
-- =====================================================
...
/*
=============================================================================
ANÁLISIS DE EMBUDO POR PAÍS – MERCADOLIBRE
=============================================================================
Objetivo: Comparar conversión del embudo por país
Herramientas: SQL, PostgreSQL
=============================================================================
*/
...
SELECT
    country,
    ROUND(usuarios_purchase * 100.0 / NULLIF(usuarios_first_visit,0),2) AS conversion_purchase_pct
FROM funnel_counts
...
/*
=============================================================================
ANÁLISIS DE RETENCIÓN DE USUARIOS – MERCADOLIBRE
=============================================================================
Objetivo: Medir retención acumulada en D7, D14, D21 y D28 por país
Herramientas: SQL, PostgreSQL
=============================================================================
*/
...
/*
=============================================================================
ANÁLISIS DE COHORTES DE RETENCIÓN – MERCADOLIBRE
=============================================================================
Objetivo: Analizar retención por cohorte mensual de registro
Herramientas: SQL, PostgreSQL
=============================================================================
*/
